...
{
    Task<Response<ProjectResponseDto>> CreateProjectAsync(Guid employerId, CreateProjectDto dto);
    ...
    Task<Response<List<ProjectResponseDto>>> GetMyProjectsAsync(Guid employerId);
