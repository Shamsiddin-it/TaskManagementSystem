...
{
    /// <inheritdoc />
    public partial class InitialIdentitySchemaPg : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultEstimatedHours = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    AutoFocusEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    BlockNotificationsDuringFocus = table.Column<bool>(type: "boolean", nullable: false),
                    DefaultFocusDurationMinutes = table.Column<int>(type: "integer", nullable: false),
                    DailyGoalHours = table.Column<int>(type: "integer", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CapacityPoints = table.Column<int>(type: "integer", nullable: false, defaultValue: 40),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Sprints_EndDateAfterStartDate", "\"EndDate\" > \"StartDate\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    DevRole = table.Column<int>(type: "integer", nullable: false),
                    ...
                    WeeklyCapacityPct = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    FocusScore = table.Column<int>(type: "integer", nullable: true),
                    ThroughputPtsPerWk = table.Column<decimal>(type: "numeric", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketType = table.Column<int>(type: "integer", nullable: false, defaultValue: 3),
                    ...
                    TotalTimeMinutes = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
